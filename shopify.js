...
(function () {
  ...
  function cartDrawerStyles(F) {
    ...
    return {
      ...
      button:    {
        'background-color': '#2ee6a3', 'color': '#06160e', 'font-family': F, 'font-weight': '800',
        'font-size': '13px', 'letter-spacing': '.04em', 'border-radius': '8px', 'padding': '14px 20px',
        ':hover': { 'background-color': '#7bf2c7' }, ':focus': { 'background-color': '#7bf2c7' }
      },
    ...
    return {
      product: {
        ...
        styles: {
          ...
          button: {
            'background-color':'#2ee6a3', 'color':'#06160e', 'border-radius':'10px',
            'font-family': F, 'font-weight':'800', 'font-size':'14px', 'letter-spacing':'.01em',
            'padding':'14px 24px',
            'box-shadow':'0 6px 18px rgba(46,230,163,0.45), 0 0 0 1px rgba(46,230,163,0.55)',
            'transition':'transform .18s ease, box-shadow .18s ease, background-color .15s ease',
            ':hover': { 'background-color':'#7bf2c7', 'box-shadow':'0 9px 26px rgba(46,230,163,0.55), 0 0 0 1px rgba(123,242,199,0.7)', 'transform':'translateY(-1px)' },
            ':focus': { 'background-color':'#7bf2c7', 'outline':'none' },
